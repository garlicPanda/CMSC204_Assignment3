...
public class SortedDoubleLinkedList_STUDENT_Test {
	...
	public Car a=new Car("Ferrari", "Roma", 2022);
	public Car b=new Car("Porsche", "Taycan", 2022);
	public Car c=new Car("Lamborghini", "Urus", 2022);
	public Car d=new Car("Tesla", "Model S", 2022);
	public Car e=new Car("Audi", "A7", 2022);
	public Car f=new Car("Bentley", "Flying spur", 2022);
